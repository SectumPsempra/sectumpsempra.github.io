...
![Downloading NVIDIA Nemotron-3-Nano-4B as a pipeline validation step. 3.9GB downloads far faster than 18GB.](/assets/images/offline-coding-agent/blog_nemotron_nano_download.png)
...
![Metal GPU framework initialization on the M1. Note the unified memory confirmation, bfloat support, and the recommendedMaxWorkingSetSize confirming access to the full 32GB memory pool.](/assets/images/offline-coding-agent/blog_nemotron_llama_server.png)
...
![An 18.3GB download failing mid-transfer via the default hf download CLI. Hours of progress, gone.](/assets/images/offline-coding-agent/blog_failed_download.png)
...
![Gemma-4 26B loaded and serving in llama.cpp. 15.9GB model size, 25.23B parameters, 262K token context window, and Vision modality confirmed.](/assets/images/offline-coding-agent/blog_model_details.png)
...
![OpenCode analyzing a project's architecture, generating detailed documentation, and proposing Git changes across 5 files. All powered locally by gemma-4-26B in 45 seconds.](/assets/images/offline-coding-agent/blog_opencode_web.png)
